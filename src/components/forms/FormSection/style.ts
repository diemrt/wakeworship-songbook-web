...
const TwFormSection = tw.section`animate-fade-in flex flex-col gap-5 justify-between pb-10 border-b md:gap-20  md:flex-row`
...
export const TwFormSectionBody = tw.section`w-full flex flex-col gap-5`

...
const TwAside = tw.aside`animate-fade-left-to-right w-96 h-screen fixed top-0 left-0 flex flex-col gap-8 px-10 py-20 bg-white border-r`
...
export const TwCloseButtonWrapper = tw.button`h-8 w-8 flex justify-center items-center bg-zinc-100 text-zinc-800 rounded-lg`

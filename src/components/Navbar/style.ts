...
const TwNavbarWrapper = tw.section`z-50 w-full h-20 p-10 pt-16 fixed flex justify-between items-center bg-white border-b`
...
export const TwAsideButton = tw(FontAwesomeIcon)`h-5 w-5`
